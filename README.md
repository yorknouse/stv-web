...
An email sending, AD authed, very much overengineered STV system that Liam made because they could!
...
`docker run -p 6691:6691 --name nouse-stv-web -v <location of db folder>:/db -v <location of toml folder>:/toml --restart=always nouse-stv-web:latest`
